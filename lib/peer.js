...
Peer.prototype.connect = function() {
  ...
  // It seems sometimes it takes crazy long to get an ECONNREFUSED error if the peer is down
  // so we set a timeout, and forcebly disconnect after 10s without connection
  setTimeout(function() {
...
Peer.prototype._sendVersion = function() {
  ...
  var message = this.messages.Version({ protocolVersion: this.protocolVersion, relay: this.relay });
